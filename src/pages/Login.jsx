...
import { Box, Button, Center, Container, Input, VStack, Text, Field, Link } from "@chakra-ui/react"
            ...
            <Container maxW="sm">
                ...
                >
                    <VStack gap={6} align="stretch" as="form" onSubmit={handleLogin}>
                        ...
                        {/* Error Message */}
                        {errorMsg && (
                            <Box p={3} bg="red.subtle" color="red.fg" borderRadius="md" fontSize="sm" borderWidth="1px" borderColor="red.muted">
                                {errorMsg}
                            </Box>
                        )}
                        ...
                        <Field.Root>
                            ...
                            <Box textAlign="right" mt={1}>
                                <Link href="#" fontSize="xs" color="blue.fg" _hover={{ textDecoration: "underline" }}>Forgot password?</Link>
                            </Box>
                        </Field.Root>
